        ...
        <div className="col">
          <section>
            ...
            <ul className="nav flex-column">
              <li className="nav-item"><Link to="/ra16-diploma/about" className="nav-link">О магазине</Link></li>
              <li className="nav-item"><Link to="/ra16-diploma/catalog" className="nav-link">Каталог</Link></li>
              <li className="nav-item"><Link to="/ra16-diploma/contacts" className="nav-link">Контакты</Link></li>
            </ul>
          </section>
        </div>
        <div className="col">
